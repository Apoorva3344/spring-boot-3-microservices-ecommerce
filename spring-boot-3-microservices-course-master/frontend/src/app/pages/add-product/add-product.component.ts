...
export class AddProductComponent {
  ...
  constructor(private fb: FormBuilder) {
    this.addProductForm = this.fb.group({
      ...
      name: ['', [Validators.required, Validators.minLength(3)]],  // Add minLength validation
      description: ['', [Validators.required, Validators.minLength(10)]],  // Add minLength validation
