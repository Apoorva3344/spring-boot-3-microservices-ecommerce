...
public class NotificationService {
    ...
    public void listen(com.techie.microservices.order.event.OrderPlacedEvent orderPlacedEvent){
        ...
        MimeMessagePreparator messagePreparator = mimeMessage -> {
            ...
            messageHelper.setFrom("apoorvareddy2024@gmail.com");
            ...
            messageHelper.setText(String.format("""
                            ...
                            Best Regards
                            Spring Boot Micro Services Shop
                            """,
        ...
        try {
            ...
            throw new RuntimeException("Exception occurred when sending mail to apoorvareddy2024@gmail.com", e);
        }
    }
}
